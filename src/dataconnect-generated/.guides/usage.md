...
```ts
import { useListUsers, useGetMyUser, useListColorSchemes, useListTimeEntries, useGetTimeEntry, useListWorkLogs, useListTimeEntriesByWorkLog, useListMyTimeEntries, useListTimeEntriesByDateRange, useCreateUserFromGoogle } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListMyTimeEntries();
...
```js
import { listUsers, getMyUser, listColorSchemes, listTimeEntries, getTimeEntry, listWorkLogs, listTimeEntriesByWorkLog, listMyTimeEntries, listTimeEntriesByDateRange, createUserFromGoogle } from '@dataconnect/generated';
