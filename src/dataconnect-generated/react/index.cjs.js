const { createUserFromGoogleRef, createTimeEntryRef, updateTimeEntryRef, deleteTimeEntryRef, createWorkLogRef, listUsersRef, listTimeEntriesRef, getTimeEntryRef, listTimeEntriesByDateRangeRef, connectorConfig } = require('../index.cjs.js');
