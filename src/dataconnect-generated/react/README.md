...
You can execute the `ListTimeEntriesByTicket` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useListTimeEntriesByTicket(dc: DataConnect, vars: ListTimeEntriesByTicketVariables, options?: useDataConnectQueryOptions<ListTimeEntriesByTicketData>): UseDataConnectQueryResult<ListTimeEntriesByTicketData, ListTimeEntriesByTicketVariables>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useListTimeEntriesByTicket(vars: ListTimeEntriesByTicketVariables, options?: useDataConnectQueryOptions<ListTimeEntriesByTicketData>): UseDataConnectQueryResult<ListTimeEntriesByTicketData, ListTimeEntriesByTicketVariables>;
```
...
```
### Return Type
Recall that calling the `ListTimeEntriesByTicket` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `ListTimeEntriesByTicket` Query is of type `ListTimeEntriesByTicketData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListTimeEntriesByTicket`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, ListTimeEntriesByTicketVariables } from '@dataconnect/generated';
import { useListTimeEntriesByTicket } from '@dataconnect/generated/react'

export default function ListTimeEntriesByTicketComponent() {
  // The `useListTimeEntriesByTicket` Query hook requires an argument of type `ListTimeEntriesByTicketVariables`:
  ...
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useListTimeEntriesByTicket(listTimeEntriesByTicketVars);
  // Variables can be defined inline as well.
  const query = useListTimeEntriesByTicket({ ticketNumber: ..., });

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useListTimeEntriesByTicket(dataConnect, listTimeEntriesByTicketVars);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useListTimeEntriesByTicket(listTimeEntriesByTicketVars, options);
...
export default function CreateTimeEntryComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ userId: ..., workLogId: ..., startTime: ..., endTime: ..., date: ..., createdAt: ..., description: ..., ticketNumber: ..., });
...
## CreateWorkLogOnly
You can execute the `CreateWorkLogOnly` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useCreateWorkLogOnly(options?: useDataConnectMutationOptions<CreateWorkLogOnlyData, FirebaseError, CreateWorkLogOnlyVariables>): UseDataConnectMutationResult<CreateWorkLogOnlyData, CreateWorkLogOnlyVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCreateWorkLogOnly(dc: DataConnect, options?: useDataConnectMutationOptions<CreateWorkLogOnlyData, FirebaseError, CreateWorkLogOnlyVariables>): UseDataConnectMutationResult<CreateWorkLogOnlyData, CreateWorkLogOnlyVariables>;
```
...
```
### Return Type
Recall that calling the `CreateWorkLogOnly` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `CreateWorkLogOnly` Mutation is of type `CreateWorkLogOnlyData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateWorkLogOnly`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, CreateWorkLogOnlyVariables } from '@dataconnect/generated';
import { useCreateWorkLogOnly } from '@dataconnect/generated/react'

export default function CreateWorkLogOnlyComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useCreateWorkLogOnly();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useCreateWorkLogOnly(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useCreateWorkLogOnly(options);
  ...
  const mutation = useCreateWorkLogOnly(dataConnect, options);

  // After calling the Mutation hook function, you must call `UseMutationResult.mutate()` to execute the Mutation.
  // The `useCreateWorkLogOnly` Mutation requires an argument of type `CreateWorkLogOnlyVariables`:
  ...
  mutation.mutate(createWorkLogOnlyVars);
  // Variables can be defined inline as well.
  ...
  mutation.mutate(createWorkLogOnlyVars, options);
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, SelectMyPerformanceModeVariables } from '@dataconnect/generated';
import { useSelectMyPerformanceMode } from '@dataconnect/generated/react'
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, SelectMySquareCornersVariables } from '@dataconnect/generated';
import { useSelectMySquareCorners } from '@dataconnect/generated/react'
...
export default function AdminUpdateTeamComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ teamId: ..., name: ..., description: ..., color: ..., weeklyTargetHours: ..., });
...
## AdminCreateTeam
You can execute the `AdminCreateTeam` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useAdminCreateTeam(options?: useDataConnectMutationOptions<AdminCreateTeamData, FirebaseError, AdminCreateTeamVariables>): UseDataConnectMutationResult<AdminCreateTeamData, AdminCreateTeamVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useAdminCreateTeam(dc: DataConnect, options?: useDataConnectMutationOptions<AdminCreateTeamData, FirebaseError, AdminCreateTeamVariables>): UseDataConnectMutationResult<AdminCreateTeamData, AdminCreateTeamVariables>;
```
...
```
### Return Type
Recall that calling the `AdminCreateTeam` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `AdminCreateTeam` Mutation is of type `AdminCreateTeamData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `AdminCreateTeam`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, AdminCreateTeamVariables } from '@dataconnect/generated';
import { useAdminCreateTeam } from '@dataconnect/generated/react'

export default function AdminCreateTeamComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useAdminCreateTeam();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useAdminCreateTeam(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useAdminCreateTeam(options);
  ...
  const mutation = useAdminCreateTeam(dataConnect, options);

  // After calling the Mutation hook function, you must call `UseMutationResult.mutate()` to execute the Mutation.
  // The `useAdminCreateTeam` Mutation requires an argument of type `AdminCreateTeamVariables`:
  const adminCreateTeamVars: AdminCreateTeamVariables = {
    name: ..., 
    description: ..., // optional
  };
  mutation.mutate(adminCreateTeamVars);
  // Variables can be defined inline as well.
  ...
  mutation.mutate(adminCreateTeamVars, options);
...
## AdminDeleteTeam
You can execute the `AdminDeleteTeam` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useAdminDeleteTeam(options?: useDataConnectMutationOptions<AdminDeleteTeamData, FirebaseError, AdminDeleteTeamVariables>): UseDataConnectMutationResult<AdminDeleteTeamData, AdminDeleteTeamVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useAdminDeleteTeam(dc: DataConnect, options?: useDataConnectMutationOptions<AdminDeleteTeamData, FirebaseError, AdminDeleteTeamVariables>): UseDataConnectMutationResult<AdminDeleteTeamData, AdminDeleteTeamVariables>;
```
...
```
### Return Type
Recall that calling the `AdminDeleteTeam` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `AdminDeleteTeam` Mutation is of type `AdminDeleteTeamData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `AdminDeleteTeam`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, AdminDeleteTeamVariables } from '@dataconnect/generated';
import { useAdminDeleteTeam } from '@dataconnect/generated/react'

export default function AdminDeleteTeamComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useAdminDeleteTeam();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useAdminDeleteTeam(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useAdminDeleteTeam(options);
  ...
  const mutation = useAdminDeleteTeam(dataConnect, options);

  // After calling the Mutation hook function, you must call `UseMutationResult.mutate()` to execute the Mutation.
  // The `useAdminDeleteTeam` Mutation requires an argument of type `AdminDeleteTeamVariables`:
  const adminDeleteTeamVars: AdminDeleteTeamVariables = {
    teamId: ..., 
  };
  mutation.mutate(adminDeleteTeamVars);
  // Variables can be defined inline as well.
  ...
  mutation.mutate(adminDeleteTeamVars, options);
