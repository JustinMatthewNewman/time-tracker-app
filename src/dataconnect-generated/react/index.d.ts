...
export function useAdminUpdateTeam(options?: useDataConnectMutationOptions<AdminUpdateTeamData, FirebaseError, AdminUpdateTeamVariables>): UseDataConnectMutationResult<AdminUpdateTeamData, AdminUpdateTeamVariables>;
export function useAdminUpdateTeam(dc: DataConnect, options?: useDataConnectMutationOptions<AdminUpdateTeamData, FirebaseError, AdminUpdateTeamVariables>): UseDataConnectMutationResult<AdminUpdateTeamData, AdminUpdateTeamVariables>;

export function useAdminCreateTeam(options?: useDataConnectMutationOptions<AdminCreateTeamData, FirebaseError, AdminCreateTeamVariables>): UseDataConnectMutationResult<AdminCreateTeamData, AdminCreateTeamVariables>;
export function useAdminCreateTeam(dc: DataConnect, options?: useDataConnectMutationOptions<AdminCreateTeamData, FirebaseError, AdminCreateTeamVariables>): UseDataConnectMutationResult<AdminCreateTeamData, AdminCreateTeamVariables>;

export function useAdminDeleteTeam(options?: useDataConnectMutationOptions<AdminDeleteTeamData, FirebaseError, AdminDeleteTeamVariables>): UseDataConnectMutationResult<AdminDeleteTeamData, AdminDeleteTeamVariables>;
export function useAdminDeleteTeam(dc: DataConnect, options?: useDataConnectMutationOptions<AdminDeleteTeamData, FirebaseError, AdminDeleteTeamVariables>): UseDataConnectMutationResult<AdminDeleteTeamData, AdminDeleteTeamVariables>;

export function useAdminAddTeamMember(options?: useDataConnectMutationOptions<AdminAddTeamMemberData, FirebaseError, AdminAddTeamMemberVariables>): UseDataConnectMutationResult<AdminAddTeamMemberData, AdminAddTeamMemberVariables>;
export function useAdminAddTeamMember(dc: DataConnect, options?: useDataConnectMutationOptions<AdminAddTeamMemberData, FirebaseError, AdminAddTeamMemberVariables>): UseDataConnectMutationResult<AdminAddTeamMemberData, AdminAddTeamMemberVariables>;

export function useAdminRemoveTeamMember(options?: useDataConnectMutationOptions<AdminRemoveTeamMemberData, FirebaseError, AdminRemoveTeamMemberVariables>): UseDataConnectMutationResult<AdminRemoveTeamMemberData, AdminRemoveTeamMemberVariables>;
export function useAdminRemoveTeamMember(dc: DataConnect, options?: useDataConnectMutationOptions<AdminRemoveTeamMemberData, FirebaseError, AdminRemoveTeamMemberVariables>): UseDataConnectMutationResult<AdminRemoveTeamMemberData, AdminRemoveTeamMemberVariables>;
...
export function useListTimeEntriesForTicket(vars: ListTimeEntriesForTicketVariables, options?: useDataConnectQueryOptions<ListTimeEntriesForTicketData>): UseDataConnectQueryResult<ListTimeEntriesForTicketData, ListTimeEntriesForTicketVariables>;
export function useListTimeEntriesForTicket(dc: DataConnect, vars: ListTimeEntriesForTicketVariables, options?: useDataConnectQueryOptions<ListTimeEntriesForTicketData>): UseDataConnectQueryResult<ListTimeEntriesForTicketData, ListTimeEntriesForTicketVariables>;
...
export function useListMyTimeEntriesByDateRange(vars: ListMyTimeEntriesByDateRangeVariables, options?: useDataConnectQueryOptions<ListMyTimeEntriesByDateRangeData>): UseDataConnectQueryResult<ListMyTimeEntriesByDateRangeData, ListMyTimeEntriesByDateRangeVariables>;
export function useListMyTimeEntriesByDateRange(dc: DataConnect, vars: ListMyTimeEntriesByDateRangeVariables, options?: useDataConnectQueryOptions<ListMyTimeEntriesByDateRangeData>): UseDataConnectQueryResult<ListMyTimeEntriesByDateRangeData, ListMyTimeEntriesByDateRangeVariables>;

export function useAdminListTimeEntriesForUsers(vars: AdminListTimeEntriesForUsersVariables, options?: useDataConnectQueryOptions<AdminListTimeEntriesForUsersData>): UseDataConnectQueryResult<AdminListTimeEntriesForUsersData, AdminListTimeEntriesForUsersVariables>;
export function useAdminListTimeEntriesForUsers(dc: DataConnect, vars: AdminListTimeEntriesForUsersVariables, options?: useDataConnectQueryOptions<AdminListTimeEntriesForUsersData>): UseDataConnectQueryResult<AdminListTimeEntriesForUsersData, AdminListTimeEntriesForUsersVariables>;

export function useAdminGetTeam(vars: AdminGetTeamVariables, options?: useDataConnectQueryOptions<AdminGetTeamData>): UseDataConnectQueryResult<AdminGetTeamData, AdminGetTeamVariables>;
export function useAdminGetTeam(dc: DataConnect, vars: AdminGetTeamVariables, options?: useDataConnectQueryOptions<AdminGetTeamData>): UseDataConnectQueryResult<AdminGetTeamData, AdminGetTeamVariables>;
